...
rm -rf u3dclient/Assets/Scripts/Model/Config/Gen/*
rm -rf u3dclient/Assets/Res/Main/Config/json/*

cp -rf C#/Client/* u3dclient/Assets/Scripts/Model/Config/Gen/
cp -rf Json/Client/* u3dclient/Assets/Res/Main/Config/json/
